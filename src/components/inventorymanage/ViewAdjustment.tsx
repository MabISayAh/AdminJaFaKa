    ...
    <div className="p-0">
      ...
      <div className="flex justify-between items-center mb-8 w-full">
        <div className="flex items-center flex-1">
          <button 
            onClick={() => navigate(`/inventory/${id}/adjustment`)}
      ...
      <div className="mt-8 bg-[#FFFFFF] rounded-2xl p-6 border border-gray-200">
        <div className="flex justify-between items-start mb-6">
          <div>
            <h2 className="text-lg font-semibold text-[#0F172A]">Adjustments</h2>
                ...
                <tr key={item.id} className="hover:bg-gray-50 transition">
                  <td className="py-4 px-6">
                    <div className="flex items-center gap-3">
                      <img src="/product-icon.png" alt="Product" className="w-9 h-9 rounded-full object-cover" />
                      <div>
                        <div className="font-medium text-[#0F172A]">{item.productName}</div>
