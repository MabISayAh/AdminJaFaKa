...
import { Search, Bell, User, BookMarked, AlertTriangle, CircleSlash2, Calendar, ArrowLeft, ChevronDown} from 'lucide-react';
      ...
      <div className="flex justify-between items-center mb-8 w-full">
        ...
        <div className="flex items-center gap-8 flex-1">
          <div className="flex items-center gap-3">
            <button onClick={() => navigate("/inventory")} className="p-2 rounded-full hover:bg-gray-100 transition">
              <ArrowLeft size={20} />
            </button>
        ...
        <div className="flex items-center gap-4 ml-8">
          <button onClick={() => setIsBellActive(!isBellActive)} className={`p-2 rounded-full transition-all duration-200 ${isBellActive ? "bg-[#DF2025] text-white" : "text-[#050F24] hover:text-[#DF2025]"}`}>
            <Bell size={24} />
          </button>
      ...
      <div className="mt-8 bg-[#FFFFFF] rounded-2xl p-6 border border-gray-200">
        <div className="flex justify-between items-start mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => navigate(`/inventory/${id}/adjustment`)}
            ...
            <button onClick={() => navigate(`/inventory/:id/batch-consumption`)}
            className="flex items-center gap-2 bg-[#DF2025] text-white px-4 py-2 rounded-2xl font-semibold hover:bg-[#b3191d] transition-colors">
              Batch Consumption
            </button>
          </div>
